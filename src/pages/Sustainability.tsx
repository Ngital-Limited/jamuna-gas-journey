    ...
    <section className="py-28 bg-foreground text-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {pillars.map((p) => (
            <div key={p.title} className="relative rounded-2xl bg-white/[0.04] border border-white/10 p-8 group hover:bg-white/[0.08] hover:-translate-y-1 transition-all duration-300 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
          {initiatives.map((item) => (
            <div key={item.title} className="relative rounded-2xl border border-border/40 bg-card p-7 group hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden">
    ...
    <section className="py-24 bg-muted/40">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {sdgGoals.map((g) => (
            <div key={g.number} className="relative rounded-2xl border border-border/40 bg-card p-8 text-center group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div key={stat.label} className="text-center rounded-2xl bg-white/5 border border-white/10 p-6 hover:bg-white/10 transition-colors">
