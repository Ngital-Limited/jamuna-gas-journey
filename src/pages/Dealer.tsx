...
const Dealer = () => {
  ...
  return (
    <Layout>
      ...
      {/* Dealer Network teaser */}
      <section id="dealers" className="py-24 bg-muted/20 relative overflow-hidden scroll-mt-24">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="section-subtitle">
            {dealers.length}+ authorized Jamuna Gas dealers across {dealerDistricts.length} districts — explore the full map and dealer details.
          </p>
          <div className="mt-8">
            <Button asChild size="lg" className="h-12 px-8 btn-shine">
              <Link to="/dealer-network">
                View Dealer Network <ArrowRight className="h-4 w-4 ml-2" />
              </Link>
            </Button>
          </div>
        </div>
